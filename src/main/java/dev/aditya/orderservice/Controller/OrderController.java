...
public class OrderController {
    ...
    public ResponseEntity<String> updateOrderPaymentDetails(@RequestBody OrderPaymentUpdateDTO orderPaymentUpdateDTO){
        orderService.updateOrderPaymentDetails(orderPaymentUpdateDTO.getOrderId()
                                              ,orderPaymentUpdateDTO.getPaymentStatus()
                                              ,orderPaymentUpdateDTO.getPaymentId()
                                              ,orderPaymentUpdateDTO.getPaymentMethod()
                                              , orderPaymentUpdateDTO.getPaymentGateway());
